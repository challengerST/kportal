...
var Listener = (function () {
    var listener = function () {
        ...
        $(document).on('click', '#ept', function () {
            ...
            location.href = '/tickets/exportD?id=' + $('#search-sel').find('option:selected').val() + '&s=' + $('#search-time').val() + '&e=' + $('#search-end').val();
        });
    };
    var init = function () {
        var data = {
            "declareCompanyId": $('#search-sel').find('option:selected').val(),
