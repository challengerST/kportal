    ...
    login: function (token, data, callback) {
        request(token, {
            ...
            , callback: function (error, resp, body) {
                var data = body && typeof body == 'object' && 'resCode' in body && body.resBody && 'agentCompany' in body.resBody && body.resBody.agentCompany && body.resBody.agentCompany.companyType == 17 ? body : {
                    resCode: 1,
                    resMsg: "登录失败，请重试",
                    resBody: null
                };
